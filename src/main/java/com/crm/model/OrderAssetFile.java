...
@Document(collection = "order_asset_files")
@Data
public class OrderAssetFile implements Serializable {

    private static final long serialVersionUID = 1L;

    public static final String SEQUENCE_NAME = "order_asset_file_sequence";
