...
@Data
public class DailySpending implements Serializable {
    ...
    public String getTotal() {
        return String.valueOf(getTwoDecimal(this.tollAmount));
    }
    ...
    public String toString() {
        return "{amount:" + getTwoDecimal(tollAmount) + ",date:" + tollDate.getDate() + "}";
    }
