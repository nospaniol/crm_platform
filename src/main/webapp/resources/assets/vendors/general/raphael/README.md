...
Something like running `python -m SimpleHTTPServer` in the `raphael` directory and hitting `http://localhost:800/0/dev/raphaelTest.html` with the browser. You should run `npm run start` before this can work.
