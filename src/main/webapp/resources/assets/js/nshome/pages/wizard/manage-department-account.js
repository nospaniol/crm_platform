...
var KTInnovativeGeneral = function () {
    ...
    var cancelInnovativeForm = function () {
        $('.kt_innovative_deposit').click(function (e) {
            ...
            var clientId = form.serializeArray()[2]["value"];
            ...
            swal({
                ...
                $.ajax({
                    type: "POST",
                    url: 'http://127.0.0.1:800/account/department/deposit/' + value + '/' + clientId + '/' + cancelItem,
        ...
        $('.kt_innovative_subtract').click(function (e) {
            ...
            swal({
                title: 'Are you sure?',
                text: "Subtract amount for " + clientName + ": ",
                icon: 'info',
                confirmButtonText: 'Yes, deposit!',
                cancelButtonText: 'No, Go back!',
                buttons: true,
                ...
                $.ajax({
                    type: "POST",
                    url: 'http://127.0.0.1:800/account/department/credit/' + value + '/' + clientId + '/' + cancelItem,
                    success: function (res) {
