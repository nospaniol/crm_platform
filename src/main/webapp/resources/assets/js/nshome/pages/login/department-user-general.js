            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if (full[0] === "No Data") {
                            ...
                            var editor =
                                    '<a href="http://127.0.0.1:800/department/edit/user/' + full[0] + '" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit User">' +
    ...
    var handleUserRegistration = function () {
        ...
        $('#kt_register_user').click(function (e) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.value) {
                     $.ajax({
                        url: 'http://127.0.0.1:800/department/register/new/user',
                        data: form.serialize(),
