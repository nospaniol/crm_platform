                                    ...
                                    <c:forEach var="transponder" items="${data}">                            
                                        <tr>   
                                            ...
                                            <td style="font-size:12px;">
                                                <a title="View Details" href="http://127.0.0.1:800/transponder/view/info/${transponder.orderId}" class="btn btn-sm btn-clean btn-icon btn-icon-md"> 
...
<script  src="<c:url value="/resources/assets/js/nshome/pages/wizard/view-order.js?v=1001" />"   type="text/javascript"></script>
