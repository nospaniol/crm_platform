                        ...
                        <form id="kt_innovative_form" class="kt-form" method="post" >
                            <div class="row row-no-padding row-col-separator-xl">    
                                <div class="form-group">
                                    <input  type="hidden" placeholder="select  category" class="form-control" value="${departmentId}" id="client" name="client"/>
                                </div>
                                ...
                                <div class="col-xl-2 col-lg-3 order-lg-1 order-xl-1">
                                    <div class="kt-login__actions">
                                        <button  id="kt_innovative_annual_department_search" class="btn btn-primary">View<i class="kt-menu__link-icon flaticon2-search-1"></i></button>
                                    </div>
                                </div>    
                            </div> 
                        </form>
...
<script  src="<c:url value="/resources/assets/js/nshome/pages/wizard/client-filter-spending.js?v=1001" />"   type="text/javascript"></script>
