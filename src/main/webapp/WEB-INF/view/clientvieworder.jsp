                                    ...
                                    <c:forEach var="transponder" items="${data}">                            
                                        <tr>   
                                            ...
                                            <td style="font-size:12px;">
                                                <a title="View Details" href="http://127.0.0.1:800/client_transponder/view/info/${transponder.orderId}" class="btn btn-sm btn-clean btn-icon btn-icon-md"> 
                                                    <i class="fas fa-eye"></i>
                                                </a> 

                                                <c:choose>
                                                    <c:when test="${transponder.orderAssetFile!=null}">  
                                                        <a target="blank" href="http://127.0.0.1:800/client_transponder/download/asset_file/${transponder.orderAssetFile.orderFileId}">
                                                            <button  class="btn btn-brand btn-pill btn-elevate">Asset File<i class="kt-menu__link-icon flaticon2-download"></i></button>
                                                        </a>  
                                                    </c:when>
                                                </c:choose>  
                                                <c:choose>
                                                    <c:when test="${transponder.orderAssetFile!=null}">  
                                                        <a target="blank" href="http://127.0.0.1:800/client_transponder/download/shipping_file/${transponder.orderAssetFile.orderFileId}">
                                                            <button  class="btn btn-brand btn-pill btn-elevate">Shipping File<i class="kt-menu__link-icon flaticon2-download"></i></button>
                                                        </a>  
                                                    </c:when>
                                                </c:choose>  
                                            </td>
