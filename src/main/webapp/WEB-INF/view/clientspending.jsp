            ...
            <div class="col-lg-5 col-xl-5 order-lg-1 order-xl-1">                 
                <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                    <div class="kt-portlet kt-portlet--head--noborder kt-portlet--height-fluid">
                        ...
                        %>
                        <a href="<c:url value='http://127.0.0.1:800/client_spending/departments/' />">
                            ...
                            <div class="row row-no-padding row-col-separator-xl">    
                                ...
                                <div class="col-xl-2 col-lg-3 order-lg-1 order-xl-1">
                                    <div class="kt-login__actions">
                                        <button  id="kt_innovative_search" class="btn btn-primary">View<i class="kt-menu__link-icon flaticon2-search-1"></i></button>
                                    </div>
                                </div>    
                            </div> 
                        </form>
