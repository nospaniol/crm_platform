...
<script src="https://unpkg.com/jspdf@latest/dist/jspdf.umd.min.js?v=1001"></script>
<script src="<c:url value="/resources/assets/js/jspdf.umd.js?v=1001" />"   type="text/javascript"></script>
<script>if (!window.jsPDF) {
        window.jsPDF = window.jspdf.jsPDF;
    }</script>
<script src="<c:url value="/resources/assets/js/mitubachi-normal.js?v=1001" />"   type="text/javascript"></script>
<script src="<c:url value="/resources/assets/js/faker.min.js?v=1001" />"   type="text/javascript"></script>
<script src="<c:url value="/resources/assets/js/jspdf.plugin.autotable.js?v=1001" />"   type="text/javascript"></script>

<script src="<c:url value="/resources/assets/js/excel/excelgenerator.js?v=1001" />"   type="text/javascript"></script>
