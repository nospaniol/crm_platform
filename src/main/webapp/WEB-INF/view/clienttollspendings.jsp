                                                                        ...
                                                                        <c:when test="${data.size() > 0 }">
                                                                            <c:forEach var="clientProfile" items="${data}">
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <a href="<c:url value='http://127.0.0.1:800/client_spending/expenditure/${clientProfile.clientProfileId}' />">
                                                                                            <button  type="button" class="btn btn-brand btn-pill btn-elevate">View Spending</button>&nbsp;
                                                                                        </a> 
                                                                                    </td>
                                                                                    <td>
                                                                                        <a href="<c:url value='http://127.0.0.1:800/client_spending/departments/${clientProfile.clientProfileId}' />">
