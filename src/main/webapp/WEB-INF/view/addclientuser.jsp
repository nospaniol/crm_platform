        ...
        <div class="kt-portlet">
            ...
            <div class="row row-no-padding row-col-separator-xl">
                <div class="col-lg-4 col-xl-4 order-lg-1 order-xl-1">
                    <form:form class="kt-form" id="client-form" action="${userUrl}" modelAttribute="user" method="POST" >
                        <div class="form-group">
                            <form:input   path="userId" class="form-control" type="hidden" id="userId"/>
                            <form:input   path="clientProfileId" class="form-control" type="hidden" value="${clientProfileId}" id="clientProfileId"/>
                        </div>
                        <div class="form-group">
...
<script src="<c:url value="/resources/assets/js/nshome/pages/login/client-user-general.js?v=1001" />"  type="text/javascript"></script>
