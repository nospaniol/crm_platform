...
<link href="<c:url value="/resources/assets/css/nsdash/style.bundle.css?v=1001" />"  rel="stylesheet" type="text/css" />
      <link href="<c:url value="/resources/assets/vendors/general/perfect-scrollbar/css/perfect-scrollbar.css?v=1001" />"  rel="stylesheet" type="text/css" />
      ...
      <link href="<c:url value="/resources/assets/vendors/general/@fortawesome/fontawesome-free/css/all.min.css?v=1001" />"  rel="stylesheet" type="text/css" />
