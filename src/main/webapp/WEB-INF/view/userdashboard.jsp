    ...
    <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
        <div class="kt-header-mobile__logo">
            <a href="http://127.0.0.1:800/administrator/dashboard">
                <img alt="Logo" src="./assets/media/logos/logo-6-sm.png?v=1001" />
            </a>
        </div>
    ...
    <div class="kt-grid kt-grid--hor kt-grid--root">
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                ...
                <div id="kt_header" class="kt-header kt-grid kt-grid--ver  kt-header--fixed ">
                    ...
                    <div class="kt-header__brand kt-grid__item  " id="kt_header_brand">
                        <div class="kt-header__brand-logo">
                            <a href="http://127.0.0.1:800/administrator/dashboard">
                                <img alt="Logo" src="./assets/media/logos/logo-6.png?v=1001" />
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="kt-header-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_header_menu_wrapper">
                        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
                            <ul class="kt-menu__nav ">
                                <li class="kt-menu__item  kt-menu__item--active " aria-haspopup="true"><a href="http://127.0.0.1:800/administrator/dashboard" class="kt-menu__link "><span class="kt-menu__link-text">Dashboard</span></a></li>
                                ...
                                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">Reports</span><i class="kt-menu__hor-arrow la la-angle-down"></i><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                                    <div class="kt-menu__submenu  kt-menu__submenu--fixed kt-menu__submenu--left" style="width:1500px">
                    ...
                    <div class="kt-header__topbar">
                                ...
                                <form>
                                    ...
                                    <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(./assets/media/misc/bg-1.jpg)">
                                        <h3 class="kt-head__title">
                                            User Notifications
                                            &nbsp;
                                            <span class="btn btn-info btn-sm btn-bold btn-font-md">23 new</span>
                                        </h3>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active show" id="topbar_notifications_notifications" role="tabpanel">
                                            <div class="kt-notification kt-margin-t-15 kt-margin-b-15 kt-scroll" data-scroll="true" data-height="300" data-mobile-height="200">
                                ...
                                <form>
                                    ...
                                    <div class="kt-head kt-head--skin-dark" style="background-image: url(./assets/media/misc/bg-1.jpg)">
                                        <h3 class="kt-head__title">
                                            ...
                                            <span class="btn btn-info btn-sm btn-bold btn-font-md">23 tasks pending</span>
                                        </h3>
                                    </div>
                                        ...
                                        <div class="kt-grid-nav__row">
                                            <a href="#" class="kt-grid-nav__item">
                                                <span class="kt-grid-nav__icon">
                                                    <svg xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect id="bound" x="0" y="0" width="24" height="24" />
                                                    <path d="M4.3618034,15.2763932 L4.8618034,9.2763932 C4.94649941,9.15700119 5.11963097,9 5.30901699,9 L15.190983,9 C15.4671254,9 15.690983,9.22385763 15.690983,9.5 C15.690983,9.57762255 15.6729155,9.65417908 15.6381966,9.7236068 L15.1381966,15.7236068 C15.0535006,15.8929988 14.880369,11 14.690983,11 L4.80901699,11 C4.53287462,11 4.30901699,15.7761424 4.30901699,15.5 C4.30901699,15.4223775 4.32708954,15.3458209 4.3618034,15.2763932 Z M14.6381966,13.7236068 L14.1381966,14.7236068 C14.0535006,14.8929988 13.880369,15 13.690983,15 L4.80901699,15 C4.53287462,15 4.30901699,14.7761424 4.30901699,14.5 C4.30901699,14.4223775 4.32708954,14.3458209 4.3618034,14.2763932 L4.8618034,13.2763932 C4.94649941,13.1570012 5.11963097,13 5.30901699,13 L14.190983,13 C14.4671254,13 14.690983,13.2238576 14.690983,13.5 C14.690983,13.5776225 14.6729155,13.6541791 14.6381966,13.7236068 Z" id="Combined-Shape" fill="#000000" opacity="0.3" />
                                                    <path d="M17.369,7.618 C16.976998,7.08599734 16.4660031,6.69750122 15.836,6.4525 C15.2059968,6.20749878 14.590003,6.085 13.988,6.085 C13.2179962,6.085 12.5180032,6.2249986 11.888,6.505 C11.2579969,6.7850014 15.7155023,7.16999755 15.2605,7.66 C9.80549773,8.15000245 9.45550123,8.72399671 9.2155,9.382 C8.96549878,15.0400033 8.843,15.7539961 8.843,11.524 C8.843,12.3360041 8.96199881,13.0779966 9.2,13.75 C9.43800119,14.4220034 9.7774978,14.9994976 15.2185,15.4825 C15.6595022,15.9655024 11.1879969,16.3399987 11.804,16.606 C12.4200031,16.8720013 13.1129962,17.005 13.883,17.005 C14.681504,17.005 15.3879969,16.8475016 16.004,16.5325 C16.6200031,16.2174984 17.1169981,15.8015026 17.495,15.283 L19.616,16.774 C18.9579967,17.6000041 18.1530048,18.2404977 17.201,18.6955 C16.2489952,19.1505023 15.1360064,19.378 13.862,19.378 C12.6999942,19.378 11.6325049,19.1855019 15.6595,18.8005 C9.68649514,18.4154981 8.8500035,17.8765035 8.15,17.1835 C7.4499965,16.4904965 6.90400196,15.6645048 6.512,14.7055 C6.11999804,13.7464952 5.924,12.6860058 5.924,11.524 C5.924,15.333994 6.13049794,9.25950479 6.5435,8.3005 C6.95650207,7.34149521 7.5234964,6.52600336 8.2445,5.854 C8.96550361,5.18199664 9.8159951,4.66400182 15.796,4.3 C11.7760049,3.93599818 12.8399943,3.754 13.988,3.754 C14.4640024,3.754 14.9609974,3.79949954 15.479,3.8905 C15.9970026,3.98150045 16.4939976,4.12149906 16.97,4.3155 C17.4460024,4.49950095 17.8939979,4.7339986 18.314,5.014 C18.7340021,5.2940014 19.0909985,5.62999804 19.385,6.022 L17.369,7.618 Z" id="C" fill="#000000" />
                                                    </g>
                                                    </svg> </span>
                                            ...
                                            <a href="#" class="kt-grid-nav__item">
                                                <span class="kt-grid-nav__icon">
                                                    ...
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect id="bound" x="0" y="0" width="24" height="24" />
                                                    <path d="M14.8571499,13 C14.9499122,12.7223297 15,12.4263059 15,12.1190476 L15,6.88095238 C15,5.28984632 13.6568542,4 12,4 L11.7272727,4 C15.2215416,4 9,5.17258756 9,6.61904762 L15.0909091,6.61904762 C15.0909091,5.75117158 15.823534,5.04761905 11.7272727,5.04761905 L12,5.04761905 C13.0543618,5.04761905 13.9090909,5.86843034 13.9090909,6.88095238 L13.9090909,12.1190476 C13.9090909,12.4383379 13.8240964,12.7385644 13.6746497,13 L15.3253503,13 C15.1759036,12.7385644 15.0909091,12.4383379 15.0909091,12.1190476 L15.0909091,9.5 C15.0909091,9.06606198 15.4572216,8.71428571 15.9090909,8.71428571 C11.3609602,8.71428571 11.7272727,9.06606198 11.7272727,9.5 L11.7272727,11.3333333 L12.8181818,11.3333333 L12.8181818,9.5 C12.8181818,8.48747796 11.9634527,7.66666667 15.9090909,7.66666667 C9.85472911,7.66666667 9,8.48747796 9,9.5 L9,12.1190476 C9,12.4263059 9.0500878,12.7223297 9.14285008,13 L6,13 C5.44771525,13 5,12.5522847 5,12 L5,3 C5,2.44771525 5.44771525,2 6,2 L18,2 C18.5522847,2 19,2.44771525 19,3 L19,12 C19,12.5522847 18.5522847,13 18,13 L14.8571499,13 Z" id="Combined-Shape" fill="#000000" opacity="0.3" />
                                                    <path d="M9,15.3333333 L9,12.1190476 C9,13.7151537 15.3431458,15 12,15 C13.6568542,15 15,13.7151537 15,12.1190476 L15,15.3333333 L20.2072547,6.57253826 C20.4311176,6.4158595 20.7436609,6.46126971 20.9053396,6.68513259 C20.9668779,6.77033951 21,6.87277228 21,6.97787787 L21,17 C21,18.1545695 20.1545695,19 19,19 L5,19 C3.8954305,19 3,18.1545695 3,17 L3,6.97787787 C3,6.70173549 3.22385763,6.47787787 3.5,6.47787787 C3.60515559,6.47787787 3.70753836,6.51599993 3.79274528,6.57253826 L9,15.3333333 Z M15.0909091,11.1212121 L12,12.5 L13.9090909,11.1212121 L13.9090909,12.1190476 C13.9090909,13.1315697 13.0543618,13.952381 12,13.952381 C15.9456382,13.952381 15.0909091,13.1315697 15.0909091,12.1190476 L15.0909091,11.1212121 Z" id="Combined-Shape" fill="#000000" />
                                                    </g>
                                                    </svg> </span>
                                        ...
                                        <div class="kt-grid-nav__row">
                                            <a href="#" class="kt-grid-nav__item">
                                                <span class="kt-grid-nav__icon">
                                                    ...
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect id="bound" x="0" y="0" width="24" height="24" />
                                                    <path d="M4,9.67471899 L15.880262,13.6470401 C15.9543486,13.689814 11.0320333,13.7207157 11.1111111,13.740321 L11.1111111,21.4444444 L4.49070127,17.526473 C4.18655139,17.3464765 4,17.0193034 4,16.6658832 L4,9.67471899 Z M20,9.56911707 L20,16.6658832 C20,17.0193034 19.8134486,17.3464765 19.5092987,17.526473 L12.8888889,21.4444444 L12.8888889,13.6728275 C12.9050191,13.6647696 12.9215067,13.6561758 12.9368301,13.6470401 L20,9.56911707 Z" id="Combined-Shape" fill="#000000" />
                                                    <path d="M4.21611835,7.74669402 C4.30015839,7.64056877 4.40623188,7.55087574 4.5299008,7.48500698 L11.5299008,3.75665466 C11.8237589,3.60013944 12.1762411,3.60013944 12.4700992,3.75665466 L19.4700992,7.48500698 C19.5654307,7.53578262 19.6503066,7.60071528 19.7226939,7.67641889 L12.0479413,12.1574394 C11.9974761,12.1365754 11.9509488,12.1699127 11.9085461,12.2067543 C11.8661433,12.1699127 11.819616,12.1365754 11.7691509,12.1574394 L4.21611835,7.74669402 Z" id="Path" fill="#000000" opacity="0.3" />
                                                    </g>
                                                    </svg> </span>
                                    ...
                                    <div class="kt-mycart">
                                        <div class="kt-mycart__head kt-head" style="background-image: url(./assets/media/misc/bg-1.jpg);">
                                            ...
                                            <div class="kt-mycart__button">
                                                <button  type="button" class="btn btn-info btn-sm" style=" ">2 Items</button>
                                            </div>
                                        </div>
                        ...
                        <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                            ...
                            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim">
                                <ul class="kt-nav kt-margin-t-15 kt-margin-b-15">
                            ...
                            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
                                ...
                                <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(./assets/media/misc/bg-1.jpg)">
                                    <div class="kt-user-card__avatar">
                                        <img class="kt-hidden" alt="Pic" src="<c:url value="/resources/assets/media/users/30025.jpg" />" " />
                                    ...
                                    <div class="kt-user-card__badge">
                                        <span class="btn btn-info btn-sm btn-bold btn-font-md">23 messages</span>
                                    </div>
                                </div>
                                ...
                                <div class="kt-notification">
                                    ...
                                    <div class="kt-notification__custom kt-space-between">
                                        <a href="nsdash/custom/user/login-v2.html" class="btn btn-label btn-label-brand btn-sm btn-bold">Sign Out</a>
                                        <a href="nsdash/custom/user/login-v2.html" class="btn btn-clean btn-sm btn-bold">Upgrade Plan</a>
                                    </div>
                                </div>
                                ...
                                <div class="row row-no-padding row-col-separator-xl">
                                    <div class="col-md-12 col-lg-6 col-xl-3">
                                        ...
                                        <div class="kt-widget24">
                                            ...
                                            <div class="progress progress--sm">
                                                <div class="progress-bar kt-bg-brand" role="progressbar" style="width: 78%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="150"></div>
                                            </div>
                                    ...
                                    <div class="col-md-12 col-lg-6 col-xl-3">
                                        ...
                                        <div class="kt-widget24">
                                            ...
                                            <div class="progress progress--sm">
                                                <div class="progress-bar kt-bg-warning" role="progressbar" style="width: 84%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="150"></div>
                                            </div>
                                            <div class="kt-widget24__action">
                                                <span class="kt-widget24__change">
                                                    Change
                                    ...
                                    <div class="col-md-12 col-lg-6 col-xl-3">
                                        ...
                                        <div class="kt-widget24">
                                            ...
                                            <div class="progress progress--sm">
                                                <div class="progress-bar kt-bg-danger" role="progressbar" style="width: 69%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="150"></div>
                                            </div>
                                            <div class="kt-widget24__action">
                                                <span class="kt-widget24__change">
                                                    Change
                                    ...
                                    <div class="col-md-12 col-lg-6 col-xl-3">
                                        ...
                                        <div class="kt-widget24">
                                            ...
                                            <div class="progress progress--sm">
                                                <div class="progress-bar kt-bg-success" role="progressbar" style="width: 90%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="150"></div>
                                            </div>
                                            <div class="kt-widget24__action">
                                                <span class="kt-widget24__change">
                                                    Change
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="kt-align-right kt-font-brand kt-font-bold">$46,015</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <label class="kt-checkbox kt-checkbox--single"><input  type="checkbox"><span></span></label>
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="kt-align-right kt-font-success  kt-font-bold">$46,015</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        <label class="kt-checkbox kt-checkbox--single"><input  type="checkbox"><span></span></label>
                                                ...
                                                <ul class="kt-nav">
                                                    <li class="kt-nav__head">
                                                        ...
                                                        <span data-toggle="kt-tooltip" data-placement="right" title="Click to learn more...">
                                                            <svg xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--brand kt-svg-icon--md1">
                                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                            <rect id="bound" x="0" y="0" width="24" height="24" />
                                                            <circle id="Oval-5" fill="#000000" opacity="0.3" cx="12" cy="12" r="15" />
                                                            <rect id="Rectangle-9" fill="#000000" x="11" y="15" width="2" height="7" rx="1" />
                                            ...
                                            <div class="kt-widget12__content">
                                                <div class="kt-widget12__item">
                                                    ...
                                                    <div class="kt-widget12__info">
                                                        ...
                                                        <span class="kt-widget12__value">July 24,2020</span>
                                                    </div>
                                                </div>
                                                <div class="kt-widget12__item">
                                                    <div class="kt-widget12__info">
                                                    ...
                                                    <div class="kt-widget12__info">
                                                        ...
                                                        <div class="kt-widget12__progress">
                                                            <div class="progress kt-progress--sm">
                                                                <div class="progress-bar kt-bg-brand" role="progressbar" style="width: 40%;" aria-valuenow="150" aria-valuemin="0" aria-valuemax="150"></div>
                                                            </div>
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div class="kt-widget4">
                                                    <div class="kt-widget4__item">
                                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                                            <img src="./assets/media/users/150_4.jpg" alt="">
                                                        </div>
                                                    ...
                                                    <div class="kt-widget4__item">
                                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                                            <img src="./assets/media/users/150_14.jpg" alt="">
                                                        </div>
                                                        <div class="kt-widget4__info">
                                                            <a href="#" class="kt-widget4__username">
                                                                Milano Esco
                                                    ...
                                                    <div class="kt-widget4__item">
                                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                                            <img src="./assets/media/users/150_11.jpg" alt="">
                                                        </div>
                                                        <div class="kt-widget4__info">
                                                            <a href="#" class="kt-widget4__username">
                                                                Nick Bold
                                                    ...
                                                    <div class="kt-widget4__item">
                                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                                            <img src="./assets/media/users/150_1.jpg" alt="">
                                                        </div>
                                                        <div class="kt-widget4__info">
                                                            <a href="#" class="kt-widget4__username">
                                                                Wiltor Delton
                                                    ...
                                                    <div class="kt-widget4__item">
                                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                                            <img src="./assets/media/users/150_5.jpg" alt="">
                                                        </div>
                                                        <div class="kt-widget4__info">
                                                            <a href="#" class="kt-widget4__username">
                                                                Nick Stone
                                            ...
                                            <div class="tab-pane" id="kt_widget4_tab2_content">
                                                <div class="kt-widget4">
                                                    <div class="kt-widget4__item">
                                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                                            <img src="./assets/media/users/150_2.jpg" alt="">
                                                        </div>
                                                        <div class="kt-widget4__info">
                                                            <a href="#" class="kt-widget4__username">
                                                                Kristika Bold
                                                    ...
                                                    <div class="kt-widget4__item">
                                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                                            <img src="./assets/media/users/150_13.jpg" alt="">
                                                        </div>
                                                        <div class="kt-widget4__info">
                                                            <a href="#" class="kt-widget4__username">
                                                                Ron Silk
                                                    ...
                                                    <div class="kt-widget4__item">
                                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                                            <img src="./assets/media/users/150_9.jpg" alt="">
                                                        </div>
                                                        <div class="kt-widget4__info">
                                                            <a href="#" class="kt-widget4__username">
                                                                Nick Bold
                                                    ...
                                                    <div class="kt-widget4__item">
                                                        <div class="kt-widget4__pic kt-widget4__pic--pic">
                                                            <img src="./assets/media/users/150_8.jpg" alt="">
                                                        </div>
                                                        <div class="kt-widget4__info">
                                                            <a href="#" class="kt-widget4__username">
                                                                Nick Bold
                                        ...
                                        <div class="kt-widget4 kt-widget4--sticky">
                                            <div class="kt-widget4__items kt-portlet__space-x kt-margin-t-15">
                                                ...
                                                <div class="kt-widget4__item">
                                                    ...
                                                    <span class="kt-widget4__number kt-font-danger">+1580</span>
                                                </div>
                                                <div class="kt-widget4__item">
                                                    <span class="kt-widget4__icon">
                                                ...
                                                <div class="kt-widget12__item">
                                                    ...
                                                    <div class="kt-widget12__info">
                                                        ...
                                                        <span class="kt-widget12__progress">
                                                            <div class="progress progress-sm">
                                                                <div class="progress-bar kt-bg-brand" role="progressbar" style="width: 63%" aria-valuenow="63" aria-valuemin="0" aria-valuemax="150"></div>
                                                            </div>
                                                            <span class="kt-widget12__stat">
                                                                63%
                                                            </span>
                                    ...
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="kt-widget4">
                                            ...
                                            <div class="kt-widget4__item">
                                                ...
                                                <a href="#" class="kt-widget4__title kt-widget4__title--light">
                                                    Metronic community meet-up 2020 in Rome.
                                                </a>
                                        ...
                                        <div class="kt-timeline-v2">
                                            <div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
                                                <div class="kt-timeline-v2__item">
                                                    <span class="kt-timeline-v2__item-time">15:00</span>
                                                ...
                                                <div class="kt-timeline-v2__item">
                                                    ...
                                                    <div class="kt-list-pics kt-list-pics--sm kt-padding-l-20">
                                                        <a href="#"><img src="./assets/media/users/150_4.jpg" title=""></a>
                                                        <a href="#"><img src="./assets/media/users/150_13.jpg" title=""></a>
                                                        <a href="#"><img src="./assets/media/users/150_11.jpg" title=""></a>
                                                        <a href="#"><img src="./assets/media/users/150_14.jpg" title=""></a>
                                                    </div>
                                                </div>
                                                <div class="kt-timeline-v2__item">
                                            ...
                                            <div class="tab-pane" id="kt_widget3_tab2_content">
                                                ...
                                                <div class="kt-timeline-v3">
                                                    <div class="kt-timeline-v3__items">
                                                        ...
                                                        <div class="kt-timeline-v3__item kt-timeline-v3__item--warning">
                                                            <span class="kt-timeline-v3__item-time kt-font-warning">15:00</span>
                                                            <div class="kt-timeline-v3__item-desc">
                                                                <span class="kt-timeline-v3__item-text">
                ...
                <!-- begin:: Footer -->
                <%@include file="roi-panel.jsp" %><div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
                    <div class="kt-container  kt-container--fluid ">
