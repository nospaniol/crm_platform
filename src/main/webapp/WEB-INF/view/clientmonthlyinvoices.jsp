...
<div class="kt-content" id="kt_content" style="padding-top:.2vh">
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid"> 
        <div class="row kt-portlet row-no-padding row-col-separator-xl">       
                    ...
                    <div class="row row-no-padding row-col-separator-xl">    
                        ...
                        <div class="col-xl-2 col-lg-3 order-lg-1 order-xl-1">
                            <div class="kt-login__actions">
                                <button  id="kt_innovative_search" class="btn btn-brand btn-pill">View<i class="kt-menu__link-icon flaticon2-search-1"></i></button>
                            </div>
                        </div>    
                    </div> 
                </form>
